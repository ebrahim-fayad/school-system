...
use App\Models\ParentsAttachment;
...
class AddParent extends Component
{
    ...
    {
        return view('livewire.admin.parents.add-parent',[
        ...
        try {
            ...
            if(!empty($this->photos)){
                foreach ($this->photos as $photo) {
                    ...
                    $path =   $photo->storeAs($this->National_ID_Father, $photoName,'upload_image');
                    ParentsAttachment::create([
                        'path' => $path,
