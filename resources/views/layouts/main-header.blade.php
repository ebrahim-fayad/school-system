            ...
            <ul class="nav navbar-nav ml-auto">
                ...
                <li class="nav-item align-content-center dropdown mr-30">
                    <div class="dropdown  nav-itemd-none d-md-flex">
                        <a href="#" class="d-flex  nav-item  pl-0 country-flag1" data-toggle="dropdown"
                            aria-expanded="false">
                            {!! LaravelLocalization::getCurrentLocaleNative() == 'english'
                                ? '<img src="' . asset('assets/images/flags/GB.png') . '" alt="GB Flag">'
                                : '<img src="' . asset('assets/images/flags/YE.png') . '" alt="YE Flag">' !!}
                           <span class="ml-2"> {{ LaravelLocalization::getCurrentLocaleNative() }}</span>
                            ...
                            @foreach (LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                <a class="dropdown-item" rel="alternate" hreflang="{{ $localeCode }}"
                                    ...
                                    @elseif($properties['native'] == 'العربية')
                                        <img src="{{ asset('assets/images/flags/YE.png') }}" alt="">
                                    @endif
                                    {{ $properties['native'] }}
                                </a>
                            @endforeach
