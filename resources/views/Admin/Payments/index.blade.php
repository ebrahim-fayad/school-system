                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($payment_students as $payment_student)
                                            ...
                                            <td>{{$payment_student->description}}</td>
                                                <td>
                                                    <a href="{{route('admin.Payment_students.edit',$payment_student->id)}}" class="btn btn-info btn-sm" role="button" aria-pressed="true"><i class="fa fa-edit"></i></a>
                                        ...
                                        @include('Admin.Payments.delete-Payment')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
