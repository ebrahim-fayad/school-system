                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($receipt_students as $receipt_student)
                                            ...
                                            <td>{{$receipt_student->description}}</td>
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm text-white" data-toggle="modal" data-target="#editReceipts_Student{{$receipt_student->student->id}}"><i class="fa fa-edit"></i></button>
                                        ...
                                        @include('Admin.Receipts.edit')
                                        @include('Admin.Receipts.delete-receipt')
                                        @endforeach
                                    </table>
                                </div>
                            </div>
